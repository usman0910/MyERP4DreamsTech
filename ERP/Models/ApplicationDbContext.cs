...
namespace ERP.Models
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<StockCableIn> StockCables { get; set; }
        public DbSet<Equipment> Equipments { get; set; }
        public DbSet<EquipmentType> EquipmentTypes { get; set; }
        public DbSet<StockEquipmentIn> StockEquipments { get; set; }
        public DbSet<Client> Clients { get; set; }
        public DbSet<SpokePerson> SpokePersons { get; set; }
        public DbSet<Project> Projects { get; set; }
        public DbSet<ProjectBillingType> ProjectBillingTypes { get; set; }
        public DbSet<ProjectService> ProjectServices { get; set; }
        public DbSet<ProjectSupplies> ProjectSupplies { get; set; }
